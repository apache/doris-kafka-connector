...
public class DorisStreamLoadTlsTest {

    @Test
    public void testStreamLoadUsesHttps() throws Exception {
        ...
        DorisStreamLoad streamLoad =
                new DorisStreamLoad(backendUtils, options, "topic", "table", httpClient);
