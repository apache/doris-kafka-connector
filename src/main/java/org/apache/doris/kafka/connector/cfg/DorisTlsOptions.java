...
/** TLS options shared by Doris HTTP and MySQL clients. */
public final class DorisTlsOptions implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        DorisTlsOptions that = (DorisTlsOptions) object;
    ...
    /** Doris protocols used by the Kafka Connector. */
    ...
    public static final class Builder {
        ...
        public DorisTlsOptions build() {
            ...
            if (!excludedProtocols.trim().isEmpty()) {
                for (String value : excludedProtocols.split(",", -1)) {
